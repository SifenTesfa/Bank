...
export default function EditBank({ auth, bank }) {
  const { data, setData, post, errors } = useForm({
    image: "",
    name: bank.name || "",
    description: bank.description || "",
    loan_interest: bank.loan_interest || "",
    website: bank.website || "",
    email: bank.email || "",
    primary_phone: bank.primary_phone || "",
    secondary_phone: bank.secondary_phone || "",
  ...
  const onSubmit = (e) => {
    e.preventDefault();
    post(route("bank.update", bank.id));
  };
        ...
        <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
          <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            ...
            >
              {bank.image_path && (
                <div className="mb-4">
                  <img src={bank.image_path} className="w-64" alt={`${bank.name} logo`} />
                </div>
              )}
              <div>
