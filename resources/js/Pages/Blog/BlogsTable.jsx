        ...
        <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
          ...
          <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400 border-b-2 border-gray-500">
            <tr className="text-nowrap">
              ...
              <th className="px-3 py-3"></th>
              {!hideContentColumn && <th className="px-3 py-3"></th>}
            ...
            {blogs.data.map((blog) => (
              ...
              >
                ...
                <td className="px-3 py-2">
                  <img src={blog.image_path} style={{ width: 60 }} alt={blog.title} />
                </td>
                {!hideContentColumn && (
                  <td className="px-3 py-2 text-gray-800">{blog.content}</td>
                )}
                <td className="px-3 py-2">{blog.created_at}</td>
                <td className="px-3 py-2">{blog.updated_at}</td>
                <td className="px-3 py-2">
                  <span
                    className={
